...
<body class="bg_img-s font_family_roboto-s">
    ...
    {{-- <footer class="page-footer ">
        <div class="container-fluid bg_light_grey-s">
            <div class="row  py-4">
                <div class="col-lg-6 col-12 align-self-center">
                    <div class="form-check fs_18px-s">
                        <input type="checkbox" class="form-check-input h_21px-s" id="term_and_condition-d" checked>
                        <label class="form-check-label mt-1" for="term_and_condition-d"><strong>I have read and accept the term and conditions.</strong></label>
                    </div>
                </div>
                <div class="col-lg-6 col-12 d-flex justify-content-md-end pt-lg-0 pt-3">
                    <button class="btn bg_grey-s br_10px-s fg_green-s py-3 mr-2 w_h_184px_x_63px-s" ><strong id="reject_term_condition-d">DECLINE</strong></button>
                    <button class="btn bg_green-s br_10px-s py-3 text-white ml-2 w_h_184px_x_63px-s" ><strong id="accept_tmd">ACCEPT</strong></button>
                </div>
            </div>
        </div>
    </footer> --}}
        ...
        let singUp = "{{ route('signup') }}";
         ...
         $('input[type="checkbox"]').click(function(){
            if($(this).prop("checked") == true){
               ...
               errorAlert('Please check checkbox');
                // setTimeout(() => {
                //     location.reload();
                // }, 2000);
            }
