...
function showPreLoaderNotification() {
    $('#loader-notification').removeClass("d-none");
    $('#loader-notification').addClass("d-flex");
    $('#loader-notification').fadeIn('fast');
...
function hidePreLoaderNotification() {
    $('#loader-notification').addClass("d-none");
    $('#loader-notification').removeClass("d-flex");
    $('#loader-notification').fadeOut('slow');
}
